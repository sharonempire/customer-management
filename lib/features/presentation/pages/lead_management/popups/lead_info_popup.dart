...
import 'package:management_software/features/presentation/pages/lead_management/popups/widgets/common_info_box.dart';
                      ...
                      return Column(
                        children: [
                          ...
                          if (leadSelected != null)
                            CommonInfoBox(leadId: leadSelected.id.toString()),
                          height20,
                        ],
                      );
                    },
